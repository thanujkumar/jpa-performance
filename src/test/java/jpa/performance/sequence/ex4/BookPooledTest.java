...
public class BookPooledTest extends JPABaseJUnitSupport {
	...
	void shouldCreateValidBook() {
		...
		IntStream.range(0, 2).forEach( i -> {
			...
			BookPooled book = new BookPooled.BookPooledBuilder().title("Pro JPA 2 in Java EE 8").description("This book from Mike Keith")
