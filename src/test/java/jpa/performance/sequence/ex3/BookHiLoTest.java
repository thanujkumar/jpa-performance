...
public class BookHiLoTest extends JPABaseJUnitSupport {
	...
	void shouldCreateValidBook() {
		...
		IntStream.range(1, 100).forEach( i -> {
			...
			BookHiLo book = new BookHiLo.BookHiLoBuilder().title("Pro JPA 2 in Java EE 8").description("This book from Mike Keith")
