...
/**
 * 
 * Non xa and looking at the impact of setMaxConnectionReuseTime
 *
 */
public class MainJNDI_JPA_NONXA {

	public static final String JDNI_NAME_DS = "oracleUCP_DS_NONXA";
	...
	static void setUp() throws Exception {
			...
			context.bind(JDNI_NAME_DS, getDatasource());
			 
			emf = Persistence.createEntityManagerFactory("customJNDI_UCP_NONXA");
